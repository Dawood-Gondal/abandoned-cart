...
define([
    ...
    {
        $('body').on(
            'click', '.stick_container #abandoned_cart_stick_layer .save', function (ele) {
                var email = $('.stick_container #abandoned_cart_stick_layer #exit-email').val();
                var message = $('.stick_container #abandoned_cart_stick_layer .message');
                if (email && validateEmail(email)) {
                    $('body').loader('show');
                    message.hide();
                    $.post(

...
(function ($) {
    $.stickToMe = function ( configs ) {
        ...
        function showbox()
        {
            if ($.data(document.body, "stick_var") != 1) {
                ...
                $('<div class="abandoned_cart_stick_block_layer"></div>').appendTo('body').css(settings.backgroundcss).fadeIn(settings.fadespeed);
                ...
                if (settings.bgclickclose) {
                    $('.abandoned_cart_stick_block_layer').click(
                        function () {
                            stick_close();
                        }
                    );
    ...
    function stick_close()
    {
        ...
        $('.abandoned_cart_stick_block_layer').fadeOut(
            function () {
                $(this).remove(); }
        );
